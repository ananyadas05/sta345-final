...
```{r}
tourney_result_26 <- read_csv("tourney_results_mod_through_2026_final.csv")
```
...
```{r}
write.csv(matchup_stats_clean_26, "~/Desktop/sta345-final/matchupstats_original_26.csv")
```
